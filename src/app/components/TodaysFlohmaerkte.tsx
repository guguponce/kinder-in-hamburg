...
export default function TodaysFlohmaerkte({
  ...
  return (
    <div className="relative flex  flex-col rounded-md bg-hh-200 hover:shadow-lg transition-all bg-opacity-50 min-w-[220px] w-fit max-w-full p-2 pt-0 shadow-sm h-fit">
