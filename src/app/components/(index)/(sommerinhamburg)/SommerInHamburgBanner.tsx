...
export default async function SommerInHamburgBanner() {
  ...
  return (
    <section className="p-4 rounded-lg bg-gradient-to-b from-hh-600 to-hh-500 w-full flex gap-4 flex-col items-center max-w-[420px] sm:max-w-[800px] text-white shadow-lg bg-opacity-10 transition-all">
      <div className="sm:gap-2 flex flex-col sm:flex-row w-full items-stretch">
        <div className="flex flex-col items-center gap-1 flex-grow">
          <Link
            ...
            className="text-3xl md:py-6 sm:py-4 text-center font-bold p-1 sm:mb-none hover:text-hh-50 hover:scale-[1.01] transition-all"
          >
            Sommer in Hamburg
          </Link>
      ...
      <Link
        href="/sommer-in-hamburg"
        className="underline underline-offset-2 font-semibold px-4 text-xl text-end text-white self-end sm:block hidden hover:scale-[1.01] transition-all hover:underline-offset-4"
      >
        Mehr entdecken
      </Link>
    </section>
