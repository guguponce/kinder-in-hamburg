...
export const STADTTEILE_TO_BEZIRK: { [key: string]: iBezirk } = {
  ...
  Neuenfelde: "Harburg",
  Cranz: "Harburg",
  Ahrensburg: "Umland Hamburg",
  Bargteheide: "Umland Hamburg",
  Bönningstedt: "Umland Hamburg",
  Ellerbek: "Umland Hamburg",
  Halstenbek: "Umland Hamburg",
  Norderstedt: "Umland Hamburg",
  Lüneburg: "Umland Hamburg",
  Pinneberg: "Umland Hamburg",
  Quickborn: "Umland Hamburg",
  Rellingen: "Umland Hamburg",
  Schenefeld: "Umland Hamburg",
  Tangstedt: "Umland Hamburg",
  "Andere Orte": "Umland Hamburg",
};
